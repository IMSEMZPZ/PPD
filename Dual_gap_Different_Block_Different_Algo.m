...
function [Cocoa_average_dual_gap_32, Cocoa_average_dual_gap_64, Cocoa_average_dual_gap_128, Cocoa_average_dual_gap_256,  Cocoa_average_dual_gap_512, Cocoa_average_dual_gap_1024] = draw_ad(file_name, C)
    %%
    loss = 'L2_svm';
    tol = 1e-12;
    n_epoch = 40;
...
function [Cocoa_average_dual_gap_32, Cocoa_average_dual_gap_64, Cocoa_average_dual_gap_128, Cocoa_average_dual_gap_256,  Cocoa_average_dual_gap_512, Cocoa_average_dual_gap_1024] = draw_psdca(file_name, C)
    %%
    loss = 'L2_svm';
    tol = 1e-12;
    n_epoch = 40;
